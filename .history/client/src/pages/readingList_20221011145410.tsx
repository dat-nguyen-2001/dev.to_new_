...
const ReadingList = () => {
    ...
    return (
        <Layout title="Reading List - DEV Community 👩‍💻👨‍💻">
            <div className="px-2 flex flex-col space-y-4 mx-auto md:w-[50vw]">
                <h1 className='text-[1.5em] font-[770]'>Reading list ({reading_list.length})</h1>
                <div className="bg-white w-full items-center text-center h-[40px] border-[1.5px] border-black/50 rounded-md">
                    <input
                        placeholder="Search..."
                        className={`w-[90%] h-[100%] outline-none pl-1 md:pl-5`} />
                </div>
