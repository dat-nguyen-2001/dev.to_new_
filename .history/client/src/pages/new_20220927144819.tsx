                ...
                <div className='overflow-y-auto bg-white h-[82vh] border-[2px] rounded-lg flex flex-col py-3 md:py-10 px-2 md:px-16 space-y-5 lg:ml-[100px]'>
                    ...
                    {/* Tags */}
                        <form className='relative'>
                            {displayTags ? (<input placeholder='Add up to 4 tags...' className='w-full outline-none' onClick={() => setDisplayTags(true)}/>
                            ...
                            </div>) : (<input placeholder='Add up to 4 tags...' className='w-full outline-none' onClick={() => setDisplayTags(true)} />)}
                        </form>
                        :
                        <form>
