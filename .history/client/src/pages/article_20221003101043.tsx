        ...
        <Layout title={title}>
            {article !== undefined &&
                <div className='flex lg:px-10'>
                    {/* // Left side */}
                    <div className='hidden md:flex flex-col h-full sticky top-[100px] z-[50] space-y-8 px-10 pt-[50px] lg:px-0 lg:pr-10'>
                    ...
                    <div className='grid grid-cols-7'>
                        <div className='col-span-5 mt-[-20px] bg-white flex flex-col space-y-3 px-3 md:mt-0 rounded-lg md:mr-5'>
                        ...
                        {/* Right side */}
                        <div className='hidden lg:inline col-span-2 rounded-lg bg-white px-3 py-5 h-full'>
                            <a href={`/${article.user.username}`} className='flex items-center space-x-1 cursor-pointer'>
                                <div className='w-8 h-8 rounded-full cursor-pointer'>
                                    <img src={article.user.profile_pic ? article.user.profile_pic : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} className='rounded-full' />
                                </div>
                            ...
                            <p className='text-lg font-semibold'>More from <div className='text-[blue] cursor-pointer'>{article.user.username}</div></p>
                        </div>
                    </div>
                </div>
            }
