                    ...
                    <form className='relative'>
                        {tagsValue !== '' &&
                            <div className='absolute top-0 flex space-x-3'>
                                {tagsList.map(tag => (
                                    <div className={`px-2 py-1 rounded flex space-x-2`} style={{backgroundColor: `#${Math.floor(Math.random()*16777215).toString(16)}`}}> Set a random background color for a tag
                                        <span>#{tag}</span>
                                        <span className='hover:text-red-700 cursor-pointer' onClick={() => setTagsValue(prevTags => prevTags.replace(`,${tag}`, ''))}>
                                            <ClearIcon />
                                        </span>
                                    </div>
                                ))}
