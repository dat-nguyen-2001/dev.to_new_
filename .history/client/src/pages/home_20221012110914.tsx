      ...
      <div className='md:grid grid-cols-7 lg:grid-cols-10 2xl:px-32'>
        ...
        <div className='col-span-5 px-2'>
          <div className='flex space-x-2 text-[1.2rem] font-semibold'>
            <div className={`text-bold cursor-pointer hover:text-blue-700 px-2 py-2 mb-2 sm:hover:bg-white rounded-md ${sortByLatest ? 'text-bold': ''}`} onClick={() => setSortByLatest(true)}>Latest</div>
