                ...
                <div className='overflow-y-auto bg-white h-[82vh] border-[2px] rounded-lg flex flex-col py-3 md:py-10 px-2 md:px-16 space-y-5 lg:ml-[100px]'>
                    ...
                    <form className='relative'>
                        ...
                        <div className='z-[100] absolute top-10 flex flex-col px-2 bg-white w-full border-[.1em] border-solid border-[#777] rounded-md max-h-[500px] overflow-y-auto'>
                            <h2 className='text-lg font-bold pt-3 pb-3'>Top tags</h2>
                            <hr></hr>
                            <ul className='flex flex-col space-y-0 cursor-pointer '>
                                {tags.map(tag => (
                                    <li key={tag} className='py-3 hover:text-[#3e45b2] hover:bg-[#f5f5f5]'>#{tag}</li>
                                ))}
                            </ul>
                        </div>
                    </form>
