...
const New = () => (
    <div className='flex flex-col content-center bg-[#f5f5f5] h-screen'>
        ...
        <div className=' bg-white h-[82vh] border-[2px] rounded-lg flex flex-col py-3 px-2 space-y-2'>
            <div>
                <button className='font-semibold px-2 py-2 rounded-md border-[2px]'>Add a cover image</button>
            </div>
            <div>
            ...
            <div>
                <textarea placeholder='Write your post content here...' className='w-full h-full border-none' />
            </div>
        </div>
