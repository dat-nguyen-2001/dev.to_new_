...
const ReadingList = () => {
    ...
    return (
        <Layout title="Reading List - DEV Community 👩‍💻👨‍💻">
            <div className="px-2 flex flex-col space-y-4 mx-auto md:w-[50vw] md:flex-row">
                <h1 className='text-[1.5em] md:text-[2em] font-[770]'>Reading list ({reading_list.length})</h1>
                <div className='flex flex-col space-y-5 ml-20'>
