...
const { getArticlesByUser, likeArticle } = articlesApi
                ...
                <div className='flex lg:px-10 2xl:px-32'>
                    ...
                    <div className='hidden md:flex flex-col h-full sticky top-[100px] z-[50] space-y-8 px-10 pt-[50px] lg:px-0 lg:pr-10'>
                        <div className='flex flex-col items-center '>
                            <span className="articleIcon hover:bg-[pink] hover:text-[red]" onClick={() => handleLikeArticle(article.title)}>
                                <FavoriteBorderIcon />
                            </span>
                            <span className="articleIcon bg-[pink] hover:text-[red]" onClick={() => handleLikeArticle(article.title)}>
                                <FavoriteBorderIcon />
                            </span>
