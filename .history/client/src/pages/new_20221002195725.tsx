...
const New = () => {
    ...
    useEffect(() => { files !== null && uploadImage() }, [files])


    //Handle tags
    const tags = ["javascript", "discuss", "devops", "webdev", "java", "interview", "react", "python", "dev's life", "programming", "css", "html", "typescript", "mongodb", "webdev", "beginners", "tutorial", "algorithms", "postgres", "threejs", "open source", "github", "docker", "testing"];
