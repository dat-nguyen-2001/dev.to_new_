        ...
        <Layout title={title}>
            {article !== undefined &&
                <div className='flex lg:px-10'>
                    ...
                    {/* // Content wrapper */}
                        <div className='col-span-5 mt-[-20px] bg-white flex flex-col space-y-3 px-3 md:mt-0 rounded-lg md:mr-5 pb-10'>
                        ...
                        {/* Right side */}
                        <div className='hidden lg:inline col-span-2 rounded-lg bg-white px-3 py-5 h-full xl:px-8'>
