...
const New = () => {
    ...
    <div className='md:grid grid-cols-4 bg-[#f5f5f5] lg:grid-cols-7 2xl:pl-[100px]'>
        <div className='flex flex-col content-center h-screen col-span-3 lg:col-span-5'>
            ...
            <div className=' overflow-hidden bg-white h-[820vh] border-[2px] rounded-lg flex flex-col py-3 md:py-10 px-2 md:px-16 space-y-5 lg:ml-[100px]'>
                <form>
                ...
                <div>
                    <textarea placeholder='Write your post content here...' className='w-full outline-none text-lg' />
                </div>
            </div>
