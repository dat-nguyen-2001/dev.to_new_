...
const New = () => (
    <div className='md:grid grid-cols-4 bg-[#f5f5f5] lg:grid-cols-3'>
        <div className='flex flex-col content-center h-screen col-span-3 lg:col-span-2 lg:ml-[100px]'>
        ...
        <div className='hidden md:inline col-span-1 h-[82vh] my-auto px-2 lg:px-5 md:mr-12 lg:mr-20'>
