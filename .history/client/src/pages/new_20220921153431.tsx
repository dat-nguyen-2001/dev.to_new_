...
const New = () => (
    <div className='md:grid grid-cols-4 bg-[#f5f5f5] lg:grid-cols-7 2xl:pl-[100px]'>
        <div className='flex flex-col content-center h-screen col-span-3 lg:col-span-5'>
            ...
            <div className=' bg-white h-[82vh] border-[2px] rounded-lg flex flex-col py-3 md:py-10 px-2 md:px-16 space-y-5 lg:ml-[100px]'>
                <div>
                    <input type="file" name='file' id='file' className='w-0 h-0 opacity-0 overflow-hidden absolute z-[-1] ' />
                    <label htmlFor='file' className='font-semibold px-3 py-2 cursor-pointer rounded-md border-black/30 border-[1.5px]'>Add a cover image</label>
                </div>
                <div>
                    <input placeholder='New post title here...' className='text-3xl md:text-4xl lg:text-5xl w-full h-[130%] outline-none placeholder:font-bold placeholder-black/70' />
                </div>
                <div>
            ...
            <div className='h-[10vh] flex items-center px-3 space-x-2 lg:ml-[100px] lg:px-0'>
                <button className='px-4 py-2 rounded bg-[blue]/70 hover:bg-[blue] text-white font-bold text-base' onClick={create}>Publish</button>
