        ...
        <Layout title={title}>
            {article !== undefined &&
                <div className='flex lg:px-10'>
                    ...
                    {/* // Content wrapper */}
                    <div className='mt-[-20px] bg-white flex flex-col space-y-3 px-3 md:mt-0 rounded-lg md:mr-5 pb-10 basis-[70%]'>
                    ...
                    {/* Right side */}
                    <div className='hidden lg:inline rounded-lg bg-white px-3 py-5 h-full xl:px-8 basis-[30%]'>
                            ...
                            {otherArticles.length === 0 ?
                                ...
                                <>
                                    {otherArticles.map((article: any) => (
                                        ...
                                        <a href='' className='text-lg text-[gray] hover:text-blue-800 cursor-pointer'>{article.title}</a>
                                        <div>
