...
const New = () => {
    ...
    const uploadImage = () => {
        ...
        formData.append('upload_preset', 'zlxlplxx').then();
        axios.post('https://api.cloudinary.com/v1_1/dfqafsyni/image/upload', formData).then((res: any) => console.log('response:',res))
    }
