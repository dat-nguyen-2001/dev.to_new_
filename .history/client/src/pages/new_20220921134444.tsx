...
const New = () => (
    <div className='flex flex-col content-center bg-[#f5f5f5] h-screen'>
        ...
        <div className=' bg-white h-[90vh] border-[2px] rounded-lg'>

        </div>
        <div className='h-[8vh] flex items-center px-3'>
            <button className='px-3 py-2 rounded bg-[blue]/80 hover:bg-[blue] text-white font-bold text-lg'>Publish</button>
            <button>Save</button>
        </div>
    </div>
)
