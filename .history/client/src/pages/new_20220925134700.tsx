            ...
            <div className='flex flex-col content-center h-screen col-span-3 lg:col-span-5'>
                ...
                <div className='overflow-y-auto bg-white h-[82vh] border-[2px] rounded-lg flex flex-col py-3 md:py-10 px-2 md:px-16 space-y-5 lg:ml-[100px]'>
                    ...
                    {displayTags ? <form className='relative'>
                        ...
                        <div tabIndex={1} className={`flex z-10 absolute top-10 flex-col px-2 bg-white w-full border-[.1em] border-solid border-[#777] rounded-md max-h-[500px] overflow-y-auto`} onBlur={() => setDisplayTags(false)} >
                            <div className='flex space-between items-center'>
                                <h2 className='text-lg font-bold pt-3 pb-3 px-3'>Top tags</h2>
                                <Clear className='w-5 h-5 cursor-pointer hover:bg-[#f5f5f5]' onClick={}/>
                            </div>
                            <hr></hr>
                            <ul tabIndex={0} className='flex flex-col space-y-0 cursor-pointer pt-3'>
                                {tags.map(tag => (
