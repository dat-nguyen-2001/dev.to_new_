...
const New = () => {
    ...
    //Handle tags
    const tags = ["javascript", "discuss", "devops", "java", "i" , "react", "python", "dev's life", "programming", "css", "html", "typescript", "mongodb", "webdev", "beginners", "tutorial", "algorithms", "postgres", "threejs", "open source", "github", "docker", "testing"];
