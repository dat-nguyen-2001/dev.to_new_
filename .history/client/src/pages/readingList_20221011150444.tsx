...
const ReadingList = () => {
    ...
    return (
        <Layout title="Reading List - DEV Community 👩‍💻👨‍💻">
            <div className="px-2 flex flex-col space-y-4 mx-auto md:w-[85vw] md:flex-row text-center">
                <h1 className='md:pt-3 text-[1.5em] md:text-[1.75em] lg:text-[2em] font-[770] md:w-[45%]'>Reading list ({reading_list.length})</h1>
