...
const likeArticle = async(username: string) => {
    await axios.post(`http://localhost:4000/articles/${username}/like`)
}

const articlesApi = {getArticles,getArticlesByTag, getArticlesByUser ,createArticle, calMinuteRead, likeArticle}
