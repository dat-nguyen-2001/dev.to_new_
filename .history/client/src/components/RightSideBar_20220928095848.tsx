...
const watercoolers = [
    { title: 'Meme Monday', comment: 29, link: 'https://dev.to/ben/meme-monday-3jjm' },
    { title: 'What are your Favorite Authors, on Which Topics, and Why?', comment: 17, link: 'https://dev.to/jmfayard/what-are-your-favorite-authors-on-which-topics-and-why-12c7' },
    { title: "Do you create your headers?", comment: 3, link: 'https://dev.to/hr21don/explain-jsx-like-im-five-27g6' },
    { title: 'Music Monday - What are you listenig to ? (New Music Edition)', comment: 10, link: 'https://dev.to/izidevspot/is-mvc-pattern-used-only-on-monolithic-web-applications-4j0' },
    { title: '100 000 Views Reached', comment: 32, link: 'https://dev.to/hr21don/explain-blockchain-like-i-am-five-2a5g' },
]
