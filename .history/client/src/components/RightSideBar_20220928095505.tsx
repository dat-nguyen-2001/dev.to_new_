...
const imfives = [
    ...
    { title: 'Is MVC pattern used only on monolithic web-application', comment: 17, link: 'https://dev.to/jmfayard/what-are-your-favorite-authors-on-which-topics-and-why-12c7' },
    { title: 'What are your Favorite Authors, on Which Topics, and Why?', comment: 17, link: 'https://dev.to/jmfayard/what-are-your-favorite-authors-on-which-topics-and-why-12c7' },
]
