...
const help = [
    { title: 'Can anyone provide an animation on the Node.js Event Loop', comment: 'forhire', link: 'https://dev.to/listings/forhire/i-develop-for-free-just-to-practice-my-react-redux-skills-4935' },
    { title: 'A Developcado Falling from Gravitee', genre: 'forhire', link: 'https://dev.to/listings/forhire/i-develop-for-free-just-to-practice-my-react-redux-skills-4935' },
]
