...
const discusses = [
    { title: 'Do DevOps suffer less ageism compared to software developers?', comment: 8, link: 'https://dev.to/listings/forhire/i-develop-for-free-just-to-practice-my-react-redux-skills-4935' },
    { title: 'Meme Monday', comment: 29, link: 'https://dev.to/listings/events/observability-for-github-ci-workflows-3d2l' },
    { title: 'Why I am not getting good at Programming', comment: 9, link: 'https://dev.to/listings/products/flatlogic-generator-50-discount-nbe' },
    { title: 'Collaborations Wanted For Noteslify - Privatie to EverNote', genre: 'collabs', link: 'https://dev.to/listings/collabs/collaborators-wanted-for-noteslify-38c' },
]
