...
const watercoolers = [
    ...
    { title: 'Music Monday - What are you listenig to ? (New Music Edition', comment: 3, link: 'https://dev.to/izidevspot/is-mvc-pattern-used-only-on-monolithic-web-applications-4j0' },
    { title: 'Explain Blockchain like I am Five', comment: 32, link: 'https://dev.to/hr21don/explain-blockchain-like-i-am-five-2a5g' },
]
