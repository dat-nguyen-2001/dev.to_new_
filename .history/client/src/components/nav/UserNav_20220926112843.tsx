    ...
    return (
        <div className='flex space-x-2 mr-3'>
            ...
            <div className='relative'>
                ...
                <div className='flex flex-col space-y-5 absolute top-10 right-0 w-[250px] z-[100] bg-white rounded border-[.1em] pl-5 pt-1'>
                    ...
                    <div className='flex flex-col space-y-3'>
                        <a className='px-4 py-2 rounded bg-[blue]/70 hover:bg-[blue] text-white font-bold text-base'>Dash Board</a>
                        <a>Create Post</a>
                        <a>Reading List</a>
                        <a>Settings</a>
                    </div>
