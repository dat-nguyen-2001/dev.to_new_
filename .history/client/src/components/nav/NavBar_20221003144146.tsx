...
const NavBar = () => {
    ...
    return (
        <div className="flex nav-wrapper w-screen h-[60px] px-2 lg:px-36 bg-white fixed top-0 border-b-[.2px] border-b-[#e5e5e5]">
            <div className="flex items-center space-x-1 h-[70%] w-full my-auto md:space-x-reverse md:space-x-4">
                ...
                <div className="searchWrapper hidden w-[400px] md:flex items-center text-center h-[40px] border-[1.5px] border-black/50 rounded">
                    <input
                        placeholder="Search..."
                        className={`w-[90%] h-[100%] outline-none ml-3 searchInput`}></input>
