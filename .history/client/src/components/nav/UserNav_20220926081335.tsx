    ...
    return (
        <div className='flex space-x-2 mr-3'>
            ...
            <a href={"/new"} className="hidden md:inline">
                <button className='min-w-[150px] h-[40px] border-solid border-[#3e51e0] border-2 rounded-md text-[#3e51e0] font-semibold hover:bg-[#3e51e0] hover:text-white hover:underline'>
                    Create Post
                </button>
            </a>
        </div>
