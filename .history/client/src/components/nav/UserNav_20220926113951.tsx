    ...
    return (
        <div className='flex space-x-2 mr-3'>
            ...
            <div className='relative'>
                ...
                {openDropMenu ? <div className='flex flex-col space-y-3 absolute top-10 right-0 w-[250px] z-[100] bg-white rounded border-[.1em] pt-2 px-2' tabIndex={0} onBlur={() => setOpenDropMenu(false)}>
