        ...
        <div className='flex space-x-2 mr-3'>
            ...
            <div className='relative' tabIndex={0} onBlur={() => setOpenDropMenu(false)}>
                <div className='w-8 h-8 rounded-full cursor-pointer hover:text-[blue]/70 hover:bg-[#e2e3f3]'>
                    <img src={user && user.profile_pic !== '' && user.profile_pic !== undefined ? user.profile_pic : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} className='mt-1 rounded-full' onClick={() => setOpenDropMenu(true)} />
                </div>
                {openDropMenu ? <div className='flex flex-col space-y-3 absolute top-10 right-0 w-[250px] z-50 bg-white rounded border-[.1em] pt-2 px-2' >
                    <div className='space-y-1' onClick={() => navigate(`/${username}`)}>
                    ...
                    <div className='flex flex-col space-y-1'>
                        ...
                        <div onClick={() => navigate(`/${username}`)} className='dropMenu'>Create Post</div>
