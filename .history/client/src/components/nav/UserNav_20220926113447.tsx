    ...
    return (
        <div className='flex space-x-2 mr-3'>
            ...
            <div className='relative'>
                ...
                <div className='flex flex-col space-y-5 absolute top-10 right-0 w-[250px] z-[100] bg-white rounded border-[.1em] pt-1 px-2'>
                    <div className='dropMenu pt-2 space-y-2'>
                        <p>
                            @{username}
                        </p>
                        <hr></hr>
                    ...
                    <div className='dropMenu pb-2 space-y-2'>
                        <hr></hr>
