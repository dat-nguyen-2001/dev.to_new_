    ...
    return (
        <div className='flex space-x-2 mr-3'>
            ...
            <div className=' relative'>
                <PersonIcon fontSize='large' className='my-auto pt-2 pl-2 w-10 h-10 rounded-lg cursor-pointer hover:text-[blue]/70 hover:bg-[#e2e3f3]' />
                <div className='absolute top-10 right-0 w-[250px] z-10 bg-white rounded border-[.1em] pl- pt-1'>
                    <div>
                        <p>
                            @{username}
                        </p>
