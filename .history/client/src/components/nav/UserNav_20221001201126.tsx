    ...
    return (
        <div className='flex space-x-2 mr-3'>
            ...
            <div className='relative' tabIndex={0} onBlur={() => setOpenDropMenu(false)}>
                <div className='w-10 h-10 rounded-lg cursor-pointer hover:text-[blue]/70 hover:bg-[#e2e3f3]'>
                    <img src={user user.profile_pic !== '' && user.profile_pic !== undefined ? user.profile_pic : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} className='my-auto pt-1 pl-1 rounded-full' onClick={() => setOpenDropMenu(true)} />
                </div>
