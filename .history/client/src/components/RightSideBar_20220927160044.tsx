const listings = [
    ...
    { title: 'Find an Entry Level Job in Tech: Switch to Become a Government Worker', genre: 'forhire', link: 'https://dev.to/listings/events/find-an-entry-level-job-in-tech-switch-to-become-a-government-worker-3o13' },
]
