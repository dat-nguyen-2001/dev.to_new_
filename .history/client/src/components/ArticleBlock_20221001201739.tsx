    ...
    return (
        <div className="flex flex-col space-y-2 bg-white rounded-md mx-auto border-[#d3d3d3] border-[.2px] pb-8">
            ...
            <div className='flex items-center space-x-1 cursor-pointer px-3 py-1'>
                <div>
                    <img src={user && user.profile_pic !== '' && user.profile_pic !== undefined ? user.profile_pic : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} className='mt-1 rounded-full' />
                </div>
