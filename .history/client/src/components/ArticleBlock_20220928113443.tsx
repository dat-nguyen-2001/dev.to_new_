            ...
            <div className='px-3 flex space-between items-center md:pl-8'>
                <div className='flex space-x-5 items-center'>
                    <div className='flex space-x-2'>
                        ...
                        <p className='hover:bg-[#f5f5f5] px-2 rounded cursor-pointer'>{article.reactions}
                        <span className='hidden lg:inline'> Reactions</span></p>
                    </div>
                    <div className='flex space-x-2'>
                        <div className='w-5 h-5'>
                            <ChatBubbleOutlineIcon className='cursor-pointer py-1' />
                        </div>
                        <p className='hover:bg-[#f5f5f5] px-2 rounded cursor-pointer py-1'>{article.comments.length}<span className='hidden lg:inline'> Comments</span></p>
                    </div>
                </div>
