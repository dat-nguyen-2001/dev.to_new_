...
const SignInForm = () => {
    ...
    return (
        <form className="flex flex-col space-y-3" method="submit" onSubmit={onSubmit={handleSubmit(onSubmit)}}>
            <div className="flex flex-col space-y-1">
                <label className="font-semibold flex">Email</label>
                <input type="text" className="registerInput" {...register("email", { required: true })} />
            </div>
            <div className="flex flex-col space-y-1">
